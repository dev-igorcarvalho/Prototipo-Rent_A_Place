...
export class DataSourceService {
  ...
  localDataSource: Local[] = [
    ...
    {id: 2, title: 'Cozy Room 2', subTitle: 'Near the supermarket', description: this.description, fotoUrl: '../../../../assets/images/local4.jpg', fotoMap: '../../assets/images/map.JPG', bairro: 'Copacabana', rating: '',  distance: 3.6, time: 0, price: 2, extras: ''},
