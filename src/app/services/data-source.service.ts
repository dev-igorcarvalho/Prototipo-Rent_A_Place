...
export class DataSourceService {
  ...
  localDataSource: Local[] = [
    ...
    {id: 2, title: 'Cozy Room 2', subTitle: 'Near the supermarket', shortTips:'Cosy Place', description: this.description, fotoUrl: '../../../../assets/images/local5.jpg', fotoMap: '../../assets/images/cateteMap.JPG', bairro: 'Catete', rating: '',  distance: 3.6, time: 0, price: 2, extras: ''},
    ...
    {id: 4, title: 'Cozy Room 4', subTitle: 'Best view ever', shortTips:'Hammock with view', description: this.description, fotoUrl: '../../../../assets/images/local1.jpg', fotoMap: '../../assets/images/botafogoMap.JPG', bairro: 'Botafogo', rating: '',  distance: 6.9, time: 0, price: 4, extras: ''},
